...
#endif
static const char *ng0 = "G:/ISE Files/p5/ForwardUnit.v";
static int ng1[] = {1, 0};
static int ng2[] = {0, 0};
...
LAB53:    t277 = (t0 + 2296);
    ...
    *((unsigned int *)t287) = (t289 | t283);
    xsi_driver_vfirst_trans(t277, 0, 1);
    t290 = (t0 + 2244);
    *((int *)t290) = 1;
...
LAB31:    t78 = (t79 + 4);
    t82 = (t80 + 4);
    if (*((unsigned int *)t78) != *((unsigned int *)t82))
        goto LAB33;
...
LAB47:    t141 = (t0 + 1060U);
    ...
    t141 = ((char*)((ng1)));
    memset(t143, 0, 8);
    if (*((unsigned int *)t142) != *((unsigned int *)t141))
        goto LAB56;
...
LAB55:    *((unsigned int *)t143) = 1;

LAB56:    memset(t146, 0, 8);
    t147 = (t143 + 4);
...
LAB62:    memcpy(t171, t146, 8);

LAB63:    memset(t203, 0, 8);
    t204 = (t171 + 4);
...
LAB98:    if (*((unsigned int *)t267) > 0)
        goto LAB99;

LAB100:    if (*((unsigned int *)t140) > 0)
        goto LAB101;

LAB102:    memcpy(t139, t276, 8);

LAB103:    goto LAB48;

LAB49:    xsi_vlog_unsigned_bit_combine(t3, 2, t134, 2, t139, 2);
    goto LAB53;

LAB51:    memcpy(t3, t134, 8);
    goto LAB53;
...
LAB61:    t158 = (t0 + 876U);
    ...
    t158 = ((char*)((ng2)));
    memset(t160, 0, 8);
    if (*((unsigned int *)t159) != *((unsigned int *)t158))
        goto LAB65;

LAB64:    t161 = (t159 + 4);
    t162 = (t158 + 4);
    if (*((unsigned int *)t161) != *((unsigned int *)t162))
        goto LAB65;
...
LAB78:    t215 = (t0 + 876U);
    ...
    t217 = *((char **)t215);
    memset(t218, 0, 8);
    if (*((unsigned int *)t216) != *((unsigned int *)t217))
        goto LAB83;

LAB81:    t215 = (t216 + 4);
    t219 = (t217 + 4);
    if (*((unsigned int *)t215) != *((unsigned int *)t219))
        goto LAB83;

LAB82:    *((unsigned int *)t218) = 1;
...
LAB99:    xsi_vlog_unsigned_bit_combine(t139, 2, t271, 2, t276, 2);
    goto LAB103;

LAB101:    memcpy(t139, t271, 8);
    goto LAB103;
...
extern void work_m_00000000003674486948_0530857640_init()
{
	static char *pe[] = {(void *)Cont_32_0,(void *)Cont_34_1};
	xsi_register_didat("work_m_00000000003674486948_0530857640", "isim/test_isim_beh.exe.sim/work/m_00000000003674486948_0530857640.didat");
